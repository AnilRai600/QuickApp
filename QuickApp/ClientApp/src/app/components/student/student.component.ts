...
export class StudentComponent implements OnInit, AfterViewInit {
  ...
  @ViewChild('studentNameTemplate', { static: true })
  studentNameTemplate: TemplateRef<any>;
  ...
  ngOnInit() {
    ...
    this.columns = [
      ...
      { prop: 'email', name: 'Email', width: 90, cellTemplate: this.emailTemplate },
      { prop: 'Address', name: 'Address', width: 120, cellTemplate: this.addressTemplate },
